...
class BoardGameMechanicsAnalyzer:
    ...
    def get_mechanic_accuracy(self):
        ...
        # Dit wordt in de GUI laten zien en duurt ongeveer 11 minuten
        mechanic_accuracies = {}
        top_200_games = self.get_top_200_games()
...
class GUIApp:
    ...
    def __init__(self, master, analyzer):
        ...
        self.label = tk.Label(master, text="Kies een spel")
        ...
        self.label_year1 = tk.Label(master, text="Voer het jaartal van publicatie in:")
        self.label_year1.pack(pady=10)

        self.entry_year1 = tk.Entry(master)
        self.entry_year1.pack(pady=10)

        self.button_analyze = tk.Button(master, text="Analyseer", command=self.analyze_game)
        self.button_analyze.pack(pady=10)

        self.label_game2 = tk.Label(master, text="Kies de naam voor het tweede bordspel:")
        ...
        self.label_year2 = tk.Label(master, text="Voer het jaartal van publicatie in:")
        self.label_year2.pack(pady=10)

        self.entry_year2 = tk.Entry(master)
        self.entry_year2.pack(pady=10)

        self.button_compare_games = tk.Button(master, text="Vergelijk Games", command=self.compare_games)
        self.button_compare_games.pack(pady=10)

        self.button_export_csv = tk.Button(master, text="Maak een lijst voor de top 200 games", command=self.export)
        self.button_export_csv.pack(pady=10)

        self.button_avg_accuracy = tk.Button(master, text="Toon gemiddelde nauwkeurigheid",
                                             command=self.show_average_accuracy)
        self.button_avg_accuracy.pack(pady=10)

        self.button_show_accuracy = tk.Button(master, text="Toon Mechanisme Nauwkeurigheid",
